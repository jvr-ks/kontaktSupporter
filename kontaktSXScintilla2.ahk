...
class Scintilla extends Gui.Custom {
    ...
    Static AddScintilla(_gui, sOptions) {
        ...
        result := DllCall("kslexer\Init","UPtr",ctl.hwnd,"UPtr") ; init DLL and get direct func/ptr
    ...
    ChunkColoring(scn, data, wordList) { ; the DLL -- avg = 0.68 secs
        result := DllCall("kslexer\ChunkColoring","UPtr",data.ptr,"Int",this.loading,"UPtr", wordList.ptr,"Int",this.CaseSense)
    ...
    DeleteRoutine(scn, data) { ; the DLL -- avg = 0.68 secs
        return DllCall("kslexer\DeleteRoutine", "UPtr", data.ptr)
    }
